...
public:
	virtual int Connect(unsigned int*lpnVidFrameTimestamp=(unsigned int*)NULL,unsigned int*lpnAudFrameTimestamp=(unsigned int*)NULL)=0;
	virtual void ReleaseConnections(void)=0;
	...
	virtual int SetSynFlag(int nFlag,unsigned int*pnVideoSynTime,unsigned int*pnAudioSynTime)=0;
};
