...
public:
	virtual void OnVIDEC_MediaFileCallbackPositionChanged(VIDEC_MediaFile*pMediaFile,unsigned int ulSeconds)=0;
	virtual void OnVIDEC_MediaFileCallbackEnd(VIDEC_MediaFile*pMediaFile)=0;
	virtual void OnVIDEC_MediaFileCallbackPCMData(VIDEC_MediaFile*pMediaFile,unsigned char*pPCMData,int nLen,unsigned int ulTimestamp)=0;
};
...
public:
	...
	virtual int Seek(unsigned int ulSeconds)=0;
