...
VIDEC_API int VIDEC_Init(unsigned int ulFlag=VIDEC_INIT_FLAG_ALL,int nUsedByProductType=0);
...
public:
	...
	//成功返回0，失败返回-1
	virtual int Open(HWND hWndParent,bool bLocal=false,unsigned int*lpnVidFrameTimestamp=NULL,unsigned int*lpnAudFrameTimestamp=NULL)=0;
	//关闭显示窗口
	virtual void Close(void)=0;
