...
public:
    void LoginServer(const char* szIP,const char* szName , const char* headUrl,
                     const char* nickName,long latitude,long longitude,const char* szGameId,const char* szGameServerId,const char* szRoomId,const char* szGroupId="",const char* szexpand= "",bool isencrypt = true);
    int logoutServer();
